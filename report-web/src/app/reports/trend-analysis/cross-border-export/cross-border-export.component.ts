...
@Component({
  selector: 'app-cross-border-export',
  templateUrl: './cross-border-export.component.html',
  styleUrls: ['./cross-border-export.component.less']
})
export class CrossBorderExportComponent implements OnInit {
