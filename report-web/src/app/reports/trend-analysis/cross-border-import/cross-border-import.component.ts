...
@Component({
  selector: 'app-cross-border-import',
  templateUrl: './cross-border-import.component.html',
  styleUrls: ['./cross-border-import.component.less']
})
export class CrossBorderImportComponent implements OnInit {
